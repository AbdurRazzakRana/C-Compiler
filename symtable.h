...
Date: April 20, 2024
Modification: Added symbol sub types
...
// added function parameter int level to avoid error as sybtable.c used function with one parameter.
